<!-- https://inspira-ui.com/docs/cn/components/cursors/sleek-line-cursor -->
...
interface Props {
  friction?: number // 鼠标移动阻尼/摩擦力，值越大拖尾跟随越慢
  trails?: number // 拖尾线条数量，值越多拖尾越密集
  size?: number // 拖尾线条的粗细/大小
  dampening?: number // 阻尼系数，值越大拖尾摆动衰减越快
  tension?: number // 张力/弹性系数，值越大拖尾线条绷得越紧
  class?: HTMLAttributes['class'] // 外层容器 canvas 的额外 CSS 类
}
