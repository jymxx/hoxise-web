<!-- https://inspira-ui.com/docs/cn/components/backgrounds/stars-background -->
...
interface StarsBackgroundProps {
  factor?: number // 鼠标视差移动的倍数
  speed?: number // 星层垂直循环动画的基础速度（秒）
  transition?: SpringOptions // 视差响应的弹簧物理配置
  starColor?: string // 星星颜色，接受任何合法 CSS 颜色
